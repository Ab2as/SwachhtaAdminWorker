...
import 'package:swachhta_app2/worker/screen/editProfileWorker.dart';
import 'package:swachhta_app2/worker/utils/app_image_pick.dart';

class EditProfileWor extends StatefulWidget {
  // const EditProfileW({super.key});
  EditProfileWor({Key? key}) : super(key: key);
  @override
  State<EditProfileWor> createState() => _EditProfileWor();
}

class _EditProfileWor extends State<EditProfileWor> {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) => EditProfileWorker()));
                    },
